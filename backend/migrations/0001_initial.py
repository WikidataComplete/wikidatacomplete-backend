    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_value', django.contrib.postgres.fields.ArrayField(base_field=models.JSONField(), default=list, size=None)),
                ('data_type', models.CharField(blank=True, default='', max_length=100)),
                ('qualifiers', models.JSONField(default=dict)),
                ('references', django.contrib.postgres.fields.ArrayField(base_field=models.JSONField(), default=list, size=None)),
